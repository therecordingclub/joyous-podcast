...
function TwitterIcon({ size = 20, className, style }: { size?: number; className?: string; style?: React.CSSProperties }) {
  return (
...
function LinkedinIcon({ size = 20, className, style }: { size?: number; className?: string; style?: React.CSSProperties }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className} style={style}>
...
function InstagramIcon({ size = 20, className, style }: { size?: number; className?: string; style?: React.CSSProperties }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className} style={style}>
...
function YoutubeIcon({ size = 20, className, style }: { size?: number; className?: string; style?: React.CSSProperties }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className} style={style}>
              ...
              {socialLinks.map((link, index) => (
                <AnimatedSection key={link.name} delay={index * 0.08}>
                  <a
                    ...
                    className={`group block rounded-2xl p-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg ${link.border}`}
                    style={{
                  ...
                  >
                    <div className="flex items-start justify-between mb-4">
                      <div
                        className={`w-12 h-12 rounded-xl flex items-center justify-center transition-colors duration-300 ${link.bg}`}
              ...
              <div className="text-center">
                ...
                >
                  <input
                    ...
                    className="flex-1 rounded-full px-6 py-4 text-sm focus:outline-none transition-colors"
                    style={{
                  ...
                  <button
                    type="submit"
                    className="px-8 py-4 rounded-full text-sm font-semibold tracking-wide uppercase transition-colors flex-shrink-0"
                    style={{
          ...
          <div className="max-w-4xl mx-auto px-6 lg:px-12">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              ...
              <AnimatedSection delay={0.1}>
                ...
                >
                  <Mic2Icon style={{ color: "var(--accent)" }} className="mb-4" />
                  <h3
                    className="text-xl font-semibold mb-3"
                    style={{ color: "var(--text-primary)" }}
                  >
...
function Mic2Icon({ className, style }: { className?: string; style?: React.CSSProperties }) {
  return (
    <svg
